...
if(file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_overall_draws.rds'))&
   file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_overall_res.rds'))){
  
  natl.overall.aggre.draws <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_overall_draws.rds'))
  natl.overall.aggre.res <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_overall_res.rds'))
  ...
  saveRDS(natl.overall.aggre.draws,paste0('natl_aggre_adm1_BYM2_RW',
                                         rw.order,'_typeIV_','overall_draws.rds'))
  ...
  saveRDS(natl.overall.aggre.res,paste0('natl_aggre_adm1_BYM2_RW',
                                       rw.order,'_typeIV_','overall_res.rds'))
...
if(file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_U_draws.rds'))&
   file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_U_res.rds'))){
  
  natl.U.aggre.draws <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_U_draws.rds'))
  natl.U.aggre.res <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_U_res.rds'))
  ...
  saveRDS(natl.U.aggre.draws,paste0('natl_aggre_adm1_BYM2_RW',
                                    rw.order,'_typeIV_','U_draws.rds'))
  ...
  saveRDS(natl.U.aggre.res,paste0('natl_aggre_adm1_BYM2_RW',
                                  rw.order,'_typeIV_','U_res.rds'))
...
if(file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_R_draws.rds'))&
   file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_R_res.rds'))){
  
  natl.R.aggre.draws <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_R_draws.rds'))
  natl.R.aggre.res <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_R_res.rds'))
  ...
  saveRDS(natl.R.aggre.draws,paste0('natl_aggre_adm1_BYM2_RW',
                                    rw.order,'_typeIV_','R_draws.rds'))
  ...
  saveRDS(natl.R.aggre.res,paste0('natl_aggre_adm1_BYM2_RW',
                                  rw.order,'_typeIV_','R_res.rds'))
...
if(file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_draws.rds'))&
   file.exists(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_res.rds'))){
  
  natl.UR.diff.aggre.draws <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_draws.rds'))
  natl.UR.diff.aggre.res <- readRDS(paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_res.rds'))
  ...
  saveRDS(natl.UR.diff.aggre.draws,paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_draws.rds'))
  ...
  saveRDS(natl.UR.diff.aggre.res,paste0('natl_aggre_adm1_BYM2_RW',rw.order,'_typeIV','_UR_diff_res.rds'))
...
if(file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','overall_5yr_est_draws.rds'))&
   file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','overall_5yr_res.rds'))){
  
  overall.5yr.aggre.draws <- readRDS(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                          'RW',rw.order,'_typeIV_','overall_5yr_est_draws.rds'))
  ...
  overall.5yr.aggre.draws <- aggre.Educ.general(aggre.grid = adm.aggre.agegrp.grid.overall,
                                                ...
                                                nSamp=1000)
  saveRDS(overall.5yr.aggre.draws,file=paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                            'RW',rw.order,'_typeIV_','overall_5yr_est_draws.rds'))
...
if(file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','U_5yr_est_draws.rds'))&
   file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','U_5yr_res.rds'))){
  
  U.5yr.aggre.draws <- readRDS(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                      'RW',rw.order,'_typeIV_','U_5yr_est_draws.rds'))
  ...
  U.5yr.aggre.draws <- aggre.Educ.general(aggre.grid = adm.aggre.agegrp.grid.U,
                                          ...
                                          new_column_names = c("region.int",'agegrp') ,
                                          nSamp=1000)
  saveRDS(U.5yr.aggre.draws,file=paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                        'RW',rw.order,'_typeIV_','U_5yr_est_draws.rds'))
...
if(file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','R_5yr_est_draws.rds'))&
   file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                      'RW',rw.order,'_typeIV_','R_5yr_res.rds'))){
  
  R.5yr.aggre.draws <- readRDS(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                      'RW',rw.order,'_typeIV_','R_5yr_est_draws.rds'))
  ...
  R.5yr.aggre.draws <- aggre.Educ.general(aggre.grid = adm.aggre.agegrp.grid.R,
                                          ...
                                          new_column_names = c("region.int",'agegrp') ,
                                          nSamp=1000)
  saveRDS(R.5yr.aggre.draws,file=paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                        'RW',rw.order,'_typeIV_','R_5yr_est_draws.rds'))
...
if(file.exists(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
  ...
  UR.diff.est.summarized <- readRDS(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                      'RW',rw.order,'_typeIV_','UR_diff_res.rds'))
  UR.diff.5yr.est.draws <-  readRDS(paste0('adm',analysis.adm.level,'_INLA_BYM2_',
                                           'RW',rw.order,'_typeIV_','UR_diff_est_draws.rds'))
...
# 
# ################################################################
# ######### aggregate integer grades to education levels
# ################################################################
# 
# test.draws <- overall.est.draws$grade_dist_p_draws
# 
# n_comb <- dim(test.draws)[1]
# n_grade <- dim(test.draws)[2]-1
# nSamp <-dim(test.draws)[3]
#   
# educ_level_cutoffs <- c(0,1,7,8,11,12)  # Defines groups: 0, 1-6, 7, 8-10, 11, 12+
# breaks <- c(educ_level_cutoffs, max(n_grade))  # Ensure it covers the full range
# labels <- educ_level_cutoffs # c("0", "1-6", "7", "8-10", "11", "12+")
# 
# # Assign grades to levels
# educ_levels <- cut(0:n_grade, breaks = breaks, labels = labels, include.lowest = TRUE, right = FALSE)
# 
# # Aggregate across n_grade dimension
# n_levels <- length(labels)
# aggregated_draws <- array(0, dim = c(n_comb, n_levels, nSamp))
# 
# for (i in seq_along(labels)) {
#   idx <- which(educ_levels == labels[i])
#   aggregated_draws[, i, ] <- apply(test.draws[, idx, , drop = FALSE], c(1, 3), sum)
# }
# 
# tmp_test <- aggregated_draws[,,1]
# sum(tmp_test[2,])